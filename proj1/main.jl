...
@fastmath function Q1_8()
  t_eval=0:0.1:100
  #dmu , sigma1, sigma2,a1,a2= [5.470934017973268, 4.474173680361383, 4.4214549387804185, 0.027108495080634055, -0.054222576328522225]
  a1=0.1 
  a2=0.05
  dmu=0
  sigma1=sigma2=3
  @inbounds prob=ODEProblem(ode2,[0.0,0.0],[0,100],(gauss3,dmu,sigma1,sigma2,a1,a2))  
